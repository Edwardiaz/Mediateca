...
public class EditarLibro extends javax.swing.JFrame {
    ...
    public EditarLibro(String codigo) throws SQLException{
        initComponents();
       ...
       try{
           ...
           if(rs.next()){           
                ...
                txtAutorLibro.setText(rs.getString("Autor"));
                txtFecha.setText(rs.getString("fecha_publicacion"));
                txtPaginas.setText(rs.getString("numero_de_paginas"));
    ...
    private void initComponents() {
        ...
        lblNewLibro.setText("Editar Libro");
            ...
            try {
                ...
                if(id.length()== 8){
                    ...
                    if(id == null || "".equals(id) || titulo == null || "".equals(titulo) || autor == null || "".equals(autor)
                        ...
                        String sql = "UPDATE materiales SET titulo = ?,codigo_autor = ?,numero_de_paginas = ?,codigo_editorial = ?,isbn = ? ,fecha_publicacion = ? ,unidades_disponibles = ? WHERE id ='"+id+"'";
