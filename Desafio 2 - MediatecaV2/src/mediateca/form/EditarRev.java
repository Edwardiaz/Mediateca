 ...
 * @author user
 */
public class EditarRev extends javax.swing.JFrame {

   Conexion co = new Conexion();
   Connection con = co.getConnection();
   
    public EditarRev(String codigo) throws SQLException{
        initComponents(); 
       ...
       try{
           String sql = "SELECT materiales.id, materiales.titulo, editoriales.nombre_editorial AS Editorial, materiales.periodicidad, date_format(fecha_publicacion, \"%d/%m/%Y\") as fecha_publicacion, materiales.unidades_disponibles, tipo_material.tipo_material AS Tipo from materiales LEFT JOIN editoriales ON editoriales.id = materiales.codigo_editorial LEFT JOIN tipo_material ON tipo_material.id = materiales.codigo_tipo_material WHERE materiales.id ='"+codigo+"'";
           ...
           if(rs.next()){           
                ...
                txtEditorialRevista.setText(rs.getString("Editorial"));
                txtPeriod.setText(rs.getString("periodicidad"));
                txtFecha.setText(rs.getString("fecha_publicacion"));
    ...
    private void initComponents() {
        ...
        lblNewLibro.setText("Editar Revista");
        ...
        btnAgregar.setLabel("Actualizar");
            ...
            try {
                ...
                if(id.length()== 8){
                    ...
                    if(id == null || "".equals(id)
                        ...
                        String sql = "UPDATE materiales SET titulo = ?,codigo_editorial = ?,periodicidad = ?,fecha_publicacion = ?,unidades_disponibles = ? WHERE id ='"+id+"'";
